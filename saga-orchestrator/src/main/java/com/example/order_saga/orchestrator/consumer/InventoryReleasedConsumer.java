...
import com.example.order_saga.orchestrator.dto.InventoryReleasedEvent;
...
public class InventoryReleasedConsumer {
  ...
  public void consume(String event) {
    log.info("Received InventoryReleased : {}", event);

    sagaCoordinatorService.handleInventoryReleased(
        objectMapper.readValue(event, InventoryReleasedEvent.class));
  }
}
